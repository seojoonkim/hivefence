...
// .wrangler/tmp/bundle-xmC5o9/checked-fetch.js
...
app.get("/api/v1/threats/latest", async (c) => {
  ...
  const stmt = since ? c.env.DB.prepare(query).bind(since, limit) : c.env.DB.prepare(query).bind(limit);
...
// .wrangler/tmp/bundle-xmC5o9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xmC5o9/middleware-loader.entry.ts
